...
export const Otp = () => {
  ...
  <div className="text-center">
    ...
    <p>
      <button className="bg-gray-500 hover:bg-gray-600 text-white rounded px-4 py-2 mr-2" onClick={(e) => setOtp([...otp.map((v) => '')])}>
        Clear
      </button>
      <button className="bg-blue-500 hover:bg-blue-600 text-white rounded px-4 py-2" onClick={()=>sendOTP()}>
        Verify OTP
      </button>
    </p>
  </div>
