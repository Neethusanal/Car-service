...
export const MechanicNavbar = () => {
  ...
  const navList = (
    <ul className="mb-4 mt-2 flex flex-col gap-2 lg:flex-row lg:items-center lg:gap-6">
      <Typography
        as="li"
        variant="small"
        color="blue-gray"
      ...
      {mechanic.status === "Approved" && (
        <>
          ...
          <Typography
            ...
            className="p-1 font-normal"
          >
            <Link to="/mechanic/chat">Chat</Link>
          </Typography>
          <Typography
            as="li"
            variant="small"
  ...
  return (
    <div className="bg-gray-600">
      <Navbar className="container mx-auto px-4 py-2 lg:px-8 lg:py-4">
